...
# Fast configuration: research instrumentation removed from the source.
# Self-contained: src/ + submit_source/ + scheduler/. System Apple clang only.
#
#   make            # live miner + range harness + scheduler + strat_probe (into bin/v2/)
#                   # bin/v1/ holds the earlier prebuilt set and is never touched by make
